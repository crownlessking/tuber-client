 ...
 * @id $27_C_1
 */
export default function form_submit_edit_facebook_bookmark(redux: IRedux) {
  return async () => {
    try {
      ...
      error_id(1040).remember_exception(e, msg((e as Error).message)); // error 1040
    }
  };
}